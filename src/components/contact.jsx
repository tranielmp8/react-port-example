...
export default function Contact() {
  ...
  return (
    <div id='Contact' className='lg:p-10 flex justify-center items-center'>
      ...
      <form action="" name="contact" netlify method="POST" data-netlify="true" className='flex flex-col gap-2 lg:w-1/2 border-2 border-red-600 p-10 rounded-xl tech-glow'>
        ...
        <textarea name="message" className='w-full my-4 rounded-lg bg-gray-500 p-4 border-2 border-red-800  text-xl text-slate-100'  placeholder='Enter Your Message' name="" id="" cols="20" rows="10"></textarea>
