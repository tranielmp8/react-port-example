...
export default function Contact() {
  ...
  return (
    <div id='Contact' className='lg:p-10 flex justify-center items-center'>
      ...
      <form name="contact" netlify netlify-honeypot="bot-field" data-netlify="true" method='post' className='flex flex-col gap-2 lg:w-1/2 border-2 border-red-600 p-10 rounded-xl tech-glow' onSubmit="submit" >
