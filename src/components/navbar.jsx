...
export default function Navbar() {
  ...
  return (
    <nav>
      <div className='h-10v flex justify-between z-50 tex-white lg:py-5 px-20 py-4 border-b border-slate-800'>
        ...
        <div className='lg:flex md:flex lg: flex-1 items center justify-end font-normal hidden'>
          <div className='-10'>
            ...
            <Link spy={true} smooth={true} to="Technology">
              <li className='hover:text-fuchsia-600 transition border-b-2 border-slate-900 hover:border-fuchsia-600 cursor-pointer'>Technology</li>
            </Link>
            <Link spy={true} smooth={true} to="Projects">
